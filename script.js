// Funzione per mostrare una sorpresa
function showSurprise() {
    alert("✨ Buon Natale! La sorpresa è... un mondo di felicità! 🎁");
}
...
function createSnow() {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        snowflake.style.animationDuration = Math.random() * 3 + 2 + 's'; // Durata animazione casuale
        snowflake.style.opacity = Math.random();
        snowContainer.appendChild(snowflake);
    }
}

// Avvia la creazione di fiocchi di neve
createSnow();
